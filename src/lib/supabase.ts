 ...
 * - 'direto': acordo próprio do operador do Receptivo (sem vínculo externo).
...
export interface Acordo {
   ...
   * 'direto' = acordo próprio do operador do Receptivo.
   * 'extra'  = acordo vinculado a outro setor (dois operadores creditados).
   * null     = não se aplica (demais setores).
   */
  tipo_receptivo?: TipoReceptivo | null;
  /** ID do operador do outro setor vinculado (apenas quando tipo_receptivo = 'extra') */
