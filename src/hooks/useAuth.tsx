...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  async function fetchPerfil(userId: string): Promise<{ tenantMismatch: string | null; missingProfile: string | null }> {
    ...
    const missingProfile = 'Login encontrado, mas o perfil do usuário ainda não foi criado no banco. Aplique a migration mais recente do Supabase e tente novamente.';
