/**
 * Componente da página de DEMO isolada (dev-only) da leitura de acordo por
 * imagem. Serve o `DropzoneImagensAcordo` real SEM login/Supabase, para
 * validar rápido o upload/colar de prints e a extração dos campos (via OCR
 * local, já que a IA ainda não está configurada).
 *
 * Renderizado por `demo-visao.tsx` (entry point de `demo-visao.html`).
 */
