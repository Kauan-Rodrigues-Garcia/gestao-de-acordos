...
export function ClassificacaoDesafio({ lista, premios, ...visual }: Props) {
  ...
  return (
    <div className="space-y-5">
      <section aria-label="Primeiros colocados" className="rounded-2xl border border-border bg-card p-3 sm:p-5">
        ...
        <PodioDesafio top5={top5} premios={premios} {...visual} />
      </section>
      {demais.length > 0 && (
        <section aria-label="Demais colocados" className="rounded-2xl border border-border bg-card p-3 sm:p-5">
