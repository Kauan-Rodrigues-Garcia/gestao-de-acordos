-- ============================================================
-- Migration: atualiza fn_analitico_destaques_dia com filtro
-- opcional por equipe (p_equipe_id DEFAULT NULL).
-- Quando passado, retorna o destaque da equipe por dia.
-- ============================================================
